        ...
        public void Insert(Usuario usuario)
        {
            ...
            try
            {
                ...
                if (usuario.Contato != null)
                {
                    ...
                    string sqlContato = "INSERT INTO Contatos(UsarioId, Telefone, Celular) VALUES (@UsarioId, @Telefone, @Celular); SELECT CAST(SCOPE_IDENTITY() AS INT);";
                ...
                if (usuario.Departamentos != null && usuario.Departamentos.Count() > 0)
                {
                    foreach (var departamento in usuario.Departamentos)
                    {
                        ...
                        _connection.Execute(sqlUsuariosDepartamentos, new { UsuarioId = usuario.Id, DeparmentoId = departamento.Id}, transaction);
                    }
                }
            ...
            catch(Exception)
            {
                ...
                {
                    //Retornar para UsuarioController alguma mensagem. Lançar uma exception.
                }
            }
            finally
            {
